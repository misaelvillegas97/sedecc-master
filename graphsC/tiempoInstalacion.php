...
$myquery1 = "SELECT date_format(CURDATE(),'%Y-%m') as fechaP, min(eva_fecha_evaluacion) as minFecha FROM min_evaluacion_instalaciones as E JOIN min_eess as EE ON(E.eess_rut = EE.eess_rut) WHERE EE.eess_estado = 1 $where2 $where";
...
JOIN min_evaluacion_instalaciones as E
