...
CASE WHEN tra_vencimiento_corma BETWEEN date_add(date_format(curdate(), '%Y-%m-01'), INTERVAL 1 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 1 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_corma, '%d-%m-%Y')) END as corma15,
      CASE WHEN tra_vencimiento_corma BETWEEN date_add(date_format(curdate(), '%Y-%m-16'), INTERVAL 1 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 2 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_corma, '%d-%m-%Y')) END as corma30,
      CASE WHEN tra_vencimiento_corma BETWEEN date_add(date_format(curdate(), '%Y-%m-16'), INTERVAL 2 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 3 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_corma, '%d-%m-%Y')) END as corma60,

      CASE WHEN tra_vencimiento_examen BETWEEN date_add(date_format(curdate(), '%Y-%m-01'), INTERVAL 1 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 1 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_examen, '%d-%m-%Y')) END as ocupa15, 
      CASE WHEN tra_vencimiento_examen BETWEEN date_add(date_format(curdate(), '%Y-%m-16'), INTERVAL 1 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 2 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_examen, '%d-%m-%Y')) END as ocupa30,
      CASE WHEN tra_vencimiento_examen BETWEEN date_add(date_format(curdate(), '%Y-%m-16'), INTERVAL 2 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 3 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_examen, '%d-%m-%Y')) END as ocupa60,

      CASE WHEN tra_vencimiento_licencia_conducir BETWEEN date_add(date_format(curdate(), '%Y-%m-01'), INTERVAL 1 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 1 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_licencia_conducir, '%d-%m-%Y')) END as licen15,
      CASE WHEN tra_vencimiento_licencia_conducir BETWEEN date_add(date_format(curdate(), '%Y-%m-16'), INTERVAL 1 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 2 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_licencia_conducir, '%d-%m-%Y')) END as licen30,
      CASE WHEN tra_vencimiento_licencia_conducir BETWEEN date_add(date_format(curdate(), '%Y-%m-16'), INTERVAL 2 month) AND date_add(date_format(curdate(), '%Y-%m-15'), INTERVAL 3 month) THEN CONCAT(tra_rut,' ',SUBSTRING_INDEX(tra_nombres, ' ', 1 ),' ',SUBSTRING_INDEX(tra_apellidos, ' ', 1 ),' ',DATE_FORMAT(tra_vencimiento_licencia_conducir, '%d-%m-%Y')) END as licen60

      FROM min_trabajador as t
      JOIN min_eess as es
      ON(t.eess_rut = es.eess_rut)
	  WHERE  es.eess_estado=1
