...
/**
 * This is the model class for table "min_respuesta_instalaciones".
 *
 * The followings are the available columns in table 'min_respuesta_instalaciones':
 ...
 */
class RespuestaInstalaciones extends CActiveRecord
{
	/**
	...
	{
		return 'min_respuesta_instalaciones';
	}
	 ...
	 * @return RespuestaInstalaciones the static model class
	 */
