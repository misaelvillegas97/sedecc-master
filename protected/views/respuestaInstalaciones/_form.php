	...
	<div class="panel-body">
		<div class="bs-example form-horizontal">
			...
			<?php $form=$this->beginWidget('CActiveForm', array(
				'id'=>'respuesta-instalaciones-form',
			...
			<!--?php echo $form->errorSummary($model); ?-->
			    ...
			    <div class="col-lg-10">
			    	...
			    	<?php echo $form->error($model,'res_respuesta'); ?>
						...
						<div class="form-group">
				<div class="col-lg-2 control-label">
			    	<?php echo $form->labelEx($model,'res_critico'); ?>
			    </div>
			    <div class="col-lg-10">
			    	<?php echo $form->textField($model,'res_critico',array('size'=>60,'maxlength'=>255, 'class'=>'form-control')); ?>
			    	<?php echo $form->error($model,'res_critico'); ?>
			    </div>
			</div>
			    ...
			    <div class="col-lg-10">
			    	...
			    	<?php echo $form->error($model,'res_seguimiento'); ?>
						...
						<div class="form-group">
				<div class="col-lg-2 control-label">
			    	<?php echo $form->labelEx($model,'res_plazo'); ?>
			    </div>
			    <div class="col-lg-10">
			    	<?php echo $form->textField($model,'res_plazo',array('class'=>'form-control')); ?>
			    	<?php echo $form->error($model,'res_plazo'); ?>
			    </div>
			</div>
