...
/* @var $data RespuestaInstalaciones */
?>
...
<div class='list-group no-radius alt'>
	...
	<br />
                          ...
                          <a class="list-group-item">
		<b><?php echo CHtml::encode($data->getAttributeLabel('res_critico')); ?></b><br>
	<?php echo CHtml::encode($data->res_critico); ?>
	<br />
	...
	<br />
                          ...
                          <a class="list-group-item">
		<b><?php echo CHtml::encode($data->getAttributeLabel('res_plazo')); ?></b><br>
	<?php echo CHtml::encode($data->res_plazo); ?>
	<br />
