...
<?php
  ...
  if(Yii::app()->controller->usertype() == 3){
    ...
    $u = Yii::app()->db->createCommand("SELECT eess_rut FROM min_equipos WHERE eq_codigo = '".Yii::app()->user->id."'")->queryScalar();
...
//index.php?r=site/page&view=indicadorInstalaciones

window.location.href = 'index.php?r=site/page&view=indicadorInstalaciones&eess='+opc;

//setTimeout("window.location='r=site/page&view=indicadorInstalaciones&eess="+opc+"'",t*1000); 
...
<div class="row" style="margin-bottom: 15px;">
    ...
    <div class="col-md-9" align="center" style="padding: 0px; background-color: #FFFFFF; width: 74%">
        <div style="width: 100%; margin-bottom: 18px; border-bottom: 2px solid #eeecee;">% Cumplimiento por Instalación</div>
  ...
  */ ?>
  ...
  <div class="col-md-2">
    ...
    <div align="center" id="chartdiv0" style="width: 100%; height: 133px; background-color: white;">
      ...
      <div style="width: 100%; margin-bottom: 5px; border-bottom: 2px solid #eeecee;">N° de Instalaciones</div>

            <?php

            $rows = Yii::app()->db->createCommand("SELECT COUNT(*) as trab FROM min_faena as E JOIN min_eess as EE ON(E.eess_rut = EE.eess_rut) WHERE EE.eess_estado = 1 ".$where2." ".$where."and fae_origen='instalaciones' ")->query()->readAll();
      ...
      <div style="width: 100%; margin-bottom: 5px; margin-top: 10px; border-bottom: 2px solid #eeecee;">N° de Evaluaciones</div>
            ...
            $rows = Yii::app()->db->createCommand("SELECT COUNT(*) as trab FROM min_evaluacion_instalaciones as E JOIN min_eess as EE ON(E.eess_rut = EE.eess_rut) WHERE EE.eess_estado = 1 ".$where2." ".$where." ")->query()->readAll();
...
<div class="row" style="margin-top: 10px;">
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-12" align="center" style="background-color: #FFFFFF;">
      ...
      <div style="border-bottom: 2px solid #eeecee;">% Cumplimiento de Instalaciones por Jefe de Faena</div>
...
<script type="text/javascript">
      ...
      AmCharts.makeChart("chartdiv",

        {
          ...
          $porc = Yii::app()->db->createCommand("SELECT AVG(eva_cache_porcentaje) FROM min_evaluacion_instalaciones as E WHERE 1 ".$where." ")->queryScalar();
...

    {
      ...
      "balloonText": "N° de Evaluaciones: [[cantidad]]",
          ...
          "dataProvider": [
            ...
            $rows = Yii::app()->db->createCommand("SELECT COUNT(E.eva_id) as cantidad, T.fae_nombre, AVG(eva_cache_porcentaje) as porc, E.eva_faena 

                           FROM min_evaluacion_instalaciones as E

                           JOIN min_faena as T

                           ON(E.eva_cod_faena = T.fae_id)
...

    {
      ...
      "balloonText": "[[Porcentaje]]%",
          ...
          "dataProvider": [
            ...
            $rows = Yii::app()->db->createCommand("SELECT eva_jefe_faena, AVG(eva_cache_porcentaje) as porc FROM min_evaluacion_instalaciones as E JOIN min_eess as EE ON(E.eess_rut = EE.eess_rut) WHERE EE.eess_estado = 1 and eva_jefe_faena != '' ".$where2." ".$where." GROUP BY eva_jefe_faena
...
var chart = AmCharts.makeChart("chartdiv99", {
  ...
  "dataLoader": {
              ...
              "url": "graphsC/tiempoInstalacion.php?eess=<?php echo $u; ?>&empresa=<?php echo $eess; ?>"
      ...
      var chart66 = AmCharts.makeChart("chartdiv66",

        {
          ...
          "dataLoader": {
              ...
              "url": "graphsC/desviacionInstalacion.php?eess=<?php echo $u; ?>&empresa=<?php echo $eess; ?>"
...
FROM(SELECT AVG(eva_cache_porcentaje) as porc FROM min_evaluacion_instalaciones as E JOIN min_eess as EE ON(E.eess_rut = EE.eess_rut) WHERE EE.eess_estado = 1  ".$where2." ".$where.") as czx
