...
window.location.href = 'index.php?r=site/page&view=indicadorAccidentes&eess='+opc;
  ...
  */ ?>
  ...
  <div class="col-md-3" style="padding-right: 0px;">
    ...
    <div class="col-md-12" align="center" style="padding: 0px; background-color: #FFFFFF;">
      ...
      <div style="width: 100%; border-bottom: 2px solid #eeecee;">Seguimiento a Medidas de Control</div>
  ...
  <div class="col-md-2">
    ...
    <div align="center" id="chartdiv0" style="width: 100%; height: 133px; background-color: white;">
      ...
      <div style="width: 100%; margin-bottom: 5px; border-bottom: 2px solid #eeecee;">N° de Instalaciones</div>
            ...
            $rows = Yii::app()->db->createCommand("SELECT COUNT(*) as trab FROM min_faena as E JOIN min_eess as EE ON(E.eess_rut = EE.eess_rut) WHERE EE.eess_estado = 1 ".$where2." ".$where." ")->query()->readAll();
      ...
      var chart66 = AmCharts.makeChart("chartdiv66",

        {
          ...
          "dataLoader": {
              ...
              "url": "graphsC/seguimientoMedidasControl.php?eess=<?php echo $u; ?>&empresa=<?php echo $eess; ?>"
