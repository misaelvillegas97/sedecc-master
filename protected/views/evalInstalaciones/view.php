...
<?php
//redirección para volver a esta misma página en caso de que no se encuentre la sesión iniciada
if(!isset(Yii::app()->user->id)){
	//$_SESSION['pag'] = "paginaprohibida.php";
	echo '<script>window.location ="http://innoapsion.cl/sedecc/index.php?r=site/login&returnurl=index.php?r=evalInstalaciones/view&id='.$model->eva_id.'"</script>';
} 
/*
if(!isset(Yii::app()->user->id)){
