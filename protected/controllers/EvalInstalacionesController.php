...
class EvalInstalacionesController extends Controller
{
	...
	public function actionExcel(){
        ...
        public function actionPdf2($id)
        {
            ...
            $evaluacion = Yii::app()->db->createCommand("CALL evaluacion_instalaciones(".$id.")")->queryRow();
            ...
            <tr>
                <td>';
                    ...
                    for ($i=0; $i < count($arrayCampos); $i++) { 
                        $valor = Yii::app()->db->createCommand("select ".$arrayCampos[$i]." from min_evaluacion_instalaciones where eva_id = ".$evaluacion['eva_id'])->queryScalar();
                        if ($arrayCampos[$i] == 'eva_comuna' || $arrayCampos[$i] == 'eva_cargo' ||  $arrayCampos[$i] == 'eva_fundo' ||  $arrayCampos[$i] == 'tra_rut' ||  $arrayCampos[$i] == 'eva_apellidos' ||  $arrayCampos[$i] == 'eva_nombres' ||  $arrayCampos[$i] == 'eva_faena' ||  $arrayCampos[$i] == 'eva_tipo_cosecha' ||  $arrayCampos[$i] == 'eva_jefe_faena') {

                        } else{
							if (trim($valor) !== '' && isset($valor)) {
							
								if (trim($arrayCampos[$i]) == 'eva_cod_faena') {
