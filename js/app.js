...
+function ($) {
  ...
  //Agregar causas
    $(document).ready(function(){
      ...
      $(".addMoreBasic").click(function(){
        if($('body').find('.fieldGroup').length < maxGroup){
          var fieldHTML = '<div class="form-group fieldGroupBasic">'+$(".fieldGroupBasic").html()+'</div>';
                    $('body').find('.fieldGroup:last').after(fieldHTML);
        }else{
          alert('Solo son permitidas '+maxGroup+' causas básicas.');
        }
            });
            $(".addMoreImmediate").click(function(){
        if($('body').find('.fieldGroupImmediate').length < maxGroup){
          var fieldHTML = '<div class="form-group fieldGroupImmediate">'+$(".fieldGroupImmediateAlone").html()+'</div>';
          $('body').find('.fieldGroup:last').after(fieldHTML);
        }else{
          alert('Solo son permitidas '+maxGroup+' causas inmediatas.');
        }
            });
            $(".addMoreMeasure").click(function(){
        if($('body').find('.fieldGroupMeasure').length < maxGroup){
          var fieldHTML = '<div class="form-group fieldGroupMeasure">'+$(".fieldGroupMeasureAlone").html()+'</div>';
          $('body').find('.fieldGroup:last').after(fieldHTML);
        }else{
          alert('Solo son permitidas '+maxGroup+' medidas de control.');
        }
            });
           
      //remove fields group
      $("body").on("click",".removebasic",function(){ 
        $(this).parents(".fieldGroupBasic").remove();
            });
            $("body").on("click",".removeimmediate",function(){ 
        $(this).parents(".fieldGroupImmediate").remove();
            });
            $("body").on("click",".removemeasure",function(){ 
        $(this).parents(".fieldGroupMeasure").remove();
      });
    });
